...
//   }
  ...
  const selectedSlot = text.split("*")[2];
    const selectedSlot1 = selectedSlot.split("_"); // Split the selectedSlot into day and time

    // Call the function to send the SMS with the selected slot information
    sendsms(selectedSlot1[0], selectedSlot1[1]);

 console.log(selectedSlot1[0], selectedSlot1[1]);
  // Call the function to send the SMS with the selected slot information


  // Provide a response to the user
  response = `END You have selected ${selectedSlot1}. You will receive a confirmation SMS shortly.`;
}

function sendsms(selectedSlot1) {
  const credentials = {
    apiKey: "c0cb33c561019e12e552b9b2e5b266fd8cbf3690b8739846e57d18edd939dd21",
    username: "FGM23",
  };
...
//   const phoneNumber = "+1234567890"; // Replace with the recipient's phone number
  ...
  const message = "Your appointment for" + selectedSlot1 + "has been confirmed.";
