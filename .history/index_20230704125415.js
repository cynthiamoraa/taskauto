...
//   }
  ...
  function sendSMS(selectedSlot) {
    ...
    // // Set the phone number(s) you want to send the SMS to
    // const recipients = ["+1234567890"]; // Replace with the recipient's phone number

    // // Compose the message content with the selected slot
    // const message = `Your appointment for ${selectedSlot} has been confirmed.`;
    const options = {
        to: phoneNumber,
        message: "Your appointment for ${selectedSlot} has been confirmed."
      };
    // Send the SMS
    sms
        .send(options);
