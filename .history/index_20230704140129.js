...
//   }
  ...
  const selectedSlot = text.split("*")[2];
    const [day, time] = selectedSlot.split("_"); // Split the selectedSlot into day and time
 ...
 console.log(selectedSlot);
  ...
  response = `END You have selected ${selectedSlot.trim()}. You will receive a confirmation SMS shortly.`;
}
